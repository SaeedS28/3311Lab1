...
extern void F975_7299(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F975_7300(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F975_7301(EIF_REFERENCE);
...
void F975_7299 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 974, Current, 0, 2, 13415);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(974, Current, 13415);
...
void F975_7300 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 974, Current, 1, 3, 13416);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(974, Current, 13416);
	RTCC(arg1, 974, l_feature_name, 1, eif_new_type(222, 0x01), 0x01);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,247,0xFF01,0xFFF9,0,176,0xFFFF};
		EIF_TYPE typres0;
	...
	RTCC(arg3, 974, l_feature_name, 3, eif_new_type(222, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F975_7301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 974, Current, 3, 0, 13417);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(974, Current, 13417);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 5141, 0x04000000, 1); /* passed */
		*(EIF_BOOLEAN *)(Current + RTWA(5141, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTE_E
	...
	if (tb1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(5141, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		...
		RTHOOK(7);
		RTDBGAA(Current, dtype, 5142, 0x04000000, 1); /* contract_violated */
		...
		*(EIF_REFERENCE *)(Current + RTWA(5145, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5146, 0x10000000, 1); /* violation_type */
...
EIF_TYPED_VALUE F975_7302 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 974, Current, 0, 0, 13418);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(974, Current, 13418);
	RTIV(Current, RTAL);
	RTHOOK(1);
