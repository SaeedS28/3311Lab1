...
extern void F982_7444(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F982_7445(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F982_7450(EIF_REFERENCE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13567);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13548);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 13548);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5238, dtype));
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13549);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 13549);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5238, dtype));
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13550);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 13550);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
/* {DATE_VALUE}.set_date */
void F982_7444 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 1, 3, 13552);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 13552);
	RTIV(Current, RTAL);
...
/* {DATE_VALUE}.set_day */
void F982_7445 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 1, 1, 13553);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 13553);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("d_large_enough", EX_PRE);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 1, 1, 13554);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 13554);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("m_large_enough", EX_PRE);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 1, 1, 13555);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 1, 13556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 1, 13557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F982_7450 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 1, 0, 13558);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
{
	GTCX
	RTOTC (F982_7457,13566,RTMS_EX_H("compact_date",12,1114629989));
}
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 981, Current, 0, 1, 13566);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
