...
extern void F981_7346(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 980, Current, 0, 2, 13584);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(980, Current, 13584);
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5148, 0xF8000172, 0); /* case */
	RTAR(Current, arg2);
...
void F981_7346 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 980, Current, 3, 0, 13585);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
