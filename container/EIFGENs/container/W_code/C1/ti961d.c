...
static const EIF_TYPE_INDEX egt_13_961 [] = {0xFF01,955,0xFFFF};
...
static const struct desc_info desc_961[] = {
	...
	{EIF_GENERIC(egt_13_961), 13295, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_961), 13296, 0xFFFFFFFF},
};
void Init961(void)
{
	IDSC(desc_961, 0, 960);
	IDSC(desc_961 + 1, 1, 960);
	IDSC(desc_961 + 32, 387, 960);
}
