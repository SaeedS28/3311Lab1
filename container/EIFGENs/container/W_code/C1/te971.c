...
extern void F971_7272(EIF_REFERENCE);
...
void F971_7272 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 970, Current, 0, 0, 13391);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	
	{
		...
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A971_76, (EIF_POINTER)(0),5125, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A971_77, (EIF_POINTER)(0),5126, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5100, dtype))(Current, ur1x);
	RTVI(Current, RTAL);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 970, Current, 3, 0, 13392);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
	...
	for (;;) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(1676, "item", loc3))(loc3)).it_i4);
		ui4_1 = ti4_1;
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1741, "item", loc2))(loc2, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		tb1 = RTEQ(tr1, tr2);
		RTHOOK(15);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 970, Current, 4, 0, 13393);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
