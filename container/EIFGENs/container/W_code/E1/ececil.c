...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5115, "test_insert_last", closed [1].it_r))(closed [1].it_r);
}
...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5116, "test_count", closed [1].it_r))(closed [1].it_r);
}
...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5117, "test_insert_at", closed [1].it_r))(closed [1].it_r);
}
...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5118, "test_remove_first", closed [1].it_r))(closed [1].it_r);
}
...
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5120, "test_assign_at", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_ARRAYED_CONTAINER test_insert_last_post_fail_1 */
void _A970_82 (void(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5121, "test_insert_last_post_fail_1", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_ARRAYED_CONTAINER test_insert_at_post_fail_1 */
void _A970_83 (void(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5122, "test_insert_at_post_fail_1", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_ARRAYED_CONTAINER test_remove_first_post_fail_1 */
void _A970_84 (void(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(5123, "test_remove_first_post_fail_1", closed [1].it_r))(closed [1].it_r);
}
