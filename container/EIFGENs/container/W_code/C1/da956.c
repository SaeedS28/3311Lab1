...
extern EIF_TYPED_VALUE F956_7082(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_7083(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_7084(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_7085(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_7086(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_7087(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_7088(EIF_REFERENCE);
extern EIF_TYPED_VALUE F956_7089(EIF_REFERENCE);
...
EIF_TYPED_VALUE F956_7082 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F956_7082,13228,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F956_7083)
EIF_TYPED_VALUE F956_7083 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 955, Current, 0, 0, 13228);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(955, Current, 13228);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 955, Current, 0, 0, 13229);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(955, Current, 13229);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800012C, 0,0); /* Result */
...
RTOID (F956_7085)
EIF_TYPED_VALUE F956_7085 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 955, Current, 0, 0, 13230);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(955, Current, 13230);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800012C, 0,0); /* Result */
...
RTOID (F956_7086)
EIF_TYPED_VALUE F956_7086 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 955, Current, 0, 0, 13231);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
EIF_TYPED_VALUE F956_7087 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F956_7087,13233,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F956_7088 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F956_7088,13234,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F956_7089 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F956_7089,13235,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit956 (void)
{
	GTCX
	RTOTS (7082,F956_7082)
	RTOTS (7083,F956_7083)
	RTOTS (7084,F956_7084)
	RTOTS (7085,F956_7085)
	RTOTS (7086,F956_7086)
	RTOTS (7087,F956_7087)
	RTOTS (7088,F956_7088)
	RTOTS (7089,F956_7089)
}
