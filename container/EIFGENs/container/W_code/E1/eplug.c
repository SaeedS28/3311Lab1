...
void egc_init_plug (void)
{
	...
	egc_system_location = "/eecs/home/saeeds28/EECS3311_Labs/Lab_1/container/EIFGENs/container/W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1468957635;
...
{
	if (egc_rcdt[0] == 0) {
		egc_rcdt[0] = 971; /* TEST_CONTAINERS */
	}
}
