...
extern EIF_TYPED_VALUE F967_7215(EIF_REFERENCE);
extern EIF_TYPED_VALUE F967_7216(EIF_REFERENCE);
extern EIF_TYPED_VALUE F967_7217(EIF_REFERENCE);
...
EIF_TYPED_VALUE F967_7215 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F967_7216 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F967_7217 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 966, Current, 0, 0, 13346);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5037, "fractional_second", tr1));
