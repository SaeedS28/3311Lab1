...
extern void F962_7146(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F962_7147(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F962_7148(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F962_7149(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F962_7150(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13267);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(961, Current, 13267);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5002, dtype));
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13268);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(961, Current, 13268);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5002, dtype));
...
EIF_TYPED_VALUE F962_7142 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13271);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(961, Current, 13271);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F962_7143 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13272);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 13272);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F962_7144 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13273);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 13273);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(5001, Dtype(Current)));
...
EIF_TYPED_VALUE F962_7145 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 961, Current, 0, 0, 13274);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(961, Current, 13274);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	tr8_1 = *(EIF_REAL_64 *)(Current + RTWA(5001, Dtype(Current)));
...
/* {TIME_VALUE}.set_hour */
void F962_7146 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 961, Current, 0, 1, 13275);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(961, Current, 13275);
	RTIV(Current, RTAL);
...
void F962_7147 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 961, Current, 0, 1, 13276);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(961, Current, 13276);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F962_7148 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 961, Current, 0, 1, 13277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(961, Current, 13277);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 961, Current, 1, 1, 13278);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F962_7150 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r8
	...
	RTEAA(l_feature_name, 961, Current, 0, 1, 13279);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
