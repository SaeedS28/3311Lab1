...
extern EIF_TYPED_VALUE F961_7155(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 960, Current, 0, 2, 13293);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {TIME_UTILITY}.div */
EIF_TYPED_VALUE F961_7155 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 13295);
	RTSA(Dtype(Current));
	RTSC;
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 13296);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
