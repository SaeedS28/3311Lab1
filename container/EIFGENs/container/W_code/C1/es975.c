...
extern void F975_7301(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F975_7302(EIF_REFERENCE);
...
void F975_7301 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 974, Current, 0, 2, 13416);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5144, 0xF800015A, 0); /* case */
	RTAR(Current, arg2);
...
void F975_7302 (EIF_REFERENCE Current)
{
	GTCX
