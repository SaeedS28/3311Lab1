...
extern void F959_7717(EIF_REFERENCE, int);
...
void F959_7106 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4939, 0xF8000107, 0); /* imp */
	{
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 958, Current, 1, 2, 13380);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 958, Current, 0, 2, 13381);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 958, Current, 0, 1, 13382);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 958, Current, 0, 1, 13383);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 958, Current, 0, 1, 13386);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 958, Current, 0, 1, 13387);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F959_7717 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 958, Current, 0, 7716);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(4946, dtype));
	if ((EIF_BOOLEAN)(ti4_1 == ti4_2)) {
		RTCK;
	} else {
		RTCF;
