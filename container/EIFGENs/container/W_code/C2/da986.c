...
extern void F986_7469(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F986_7470(EIF_REFERENCE);
extern EIF_TYPED_VALUE F986_7471(EIF_REFERENCE);
extern void F986_7472(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F986_7478(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F986_7497(EIF_REFERENCE);
...
/* {DATE_TIME_CODE}.make */
void F986_7469 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 13579);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F986_7471 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 13580);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(5265, Dtype(Current)));
	switch (ti4_1) {
		case 18L:
		case 19L:
		case 20L:
...
void F986_7472 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 985, Current, 1, 1, 13581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5259, 0xF80000DE, 0); /* value */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5259, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	if (tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 5260, 0x10000000, 1); /* count_max */
		*(EIF_INTEGER_32 *)(Current + RTWA(5260, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		RTHOOK(6);
		RTDBGAA(Current, dtype, 5261, 0x10000000, 1); /* count_min */
		*(EIF_INTEGER_32 *)(Current + RTWA(5261, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		RTHOOK(7);
		RTDBGAL(Current, 1, 0xF80000DE, 0, 0); /* loc1 */
		loc1 = RTMS_EX_H("day-numeric",11,781450083);
		RTHOOK(8);
		RTDBGAA(Current, dtype, 5263, 0x10000000, 1); /* value_max */
		*(EIF_INTEGER_32 *)(Current + RTWA(5263, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 31L);
		RTHOOK(9);
		RTDBGAA(Current, dtype, 5264, 0x10000000, 1); /* value_min */
		*(EIF_INTEGER_32 *)(Current + RTWA(5264, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
		RTHOOK(10);
		...
		*(EIF_INTEGER_32 *)(Current + RTWA(5265, dtype)) = (EIF_INTEGER_32) ti4_1;
	} else {
		RTHOOK(13);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5259, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		...
		if (tb1) {
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5260, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(15);
			RTDBGAA(Current, dtype, 5261, 0x10000000, 1); /* count_min */
			*(EIF_INTEGER_32 *)(Current + RTWA(5261, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
			RTHOOK(16);
			RTDBGAL(Current, 1, 0xF80000DE, 0, 0); /* loc1 */
			...
			*(EIF_INTEGER_32 *)(Current + RTWA(5265, dtype)) = (EIF_INTEGER_32) ti4_1;
			...
			if (tb1) {
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(5260, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(24);
				RTDBGAA(Current, dtype, 5261, 0x10000000, 1); /* count_min */
				*(EIF_INTEGER_32 *)(Current + RTWA(5261, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
				RTHOOK(25);
				RTDBGAL(Current, 1, 0xF80000DE, 0, 0); /* loc1 */
				loc1 = RTMS_EX_H("day-text",8,1643751284);
				RTHOOK(26);
				RTDBGAA(Current, dtype, 5263, 0x10000000, 1); /* value_max */
				*(EIF_INTEGER_32 *)(Current + RTWA(5263, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 7L);
				RTHOOK(27);
				RTDBGAA(Current, dtype, 5264, 0x10000000, 1); /* value_min */
				*(EIF_INTEGER_32 *)(Current + RTWA(5264, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
				RTHOOK(28);
				...
				*(EIF_INTEGER_32 *)(Current + RTWA(5265, dtype)) = (EIF_INTEGER_32) ti4_1;
				...
				if (tb1) {
					...
					*(EIF_INTEGER_32 *)(Current + RTWA(5260, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(33);
					RTDBGAA(Current, dtype, 5261, 0x10000000, 1); /* count_min */
					*(EIF_INTEGER_32 *)(Current + RTWA(5261, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 4L);
					RTHOOK(34);
					RTDBGAL(Current, 1, 0xF80000DE, 0, 0); /* loc1 */
						...
						*(EIF_INTEGER_32 *)(Current + RTWA(5264, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
						...
						if (tb1) {
							...
							*(EIF_INTEGER_32 *)(Current + RTWA(5261, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							...
							RTHOOK(53);
							RTDBGAA(Current, dtype, 5263, 0x10000000, 1); /* value_max */
							*(EIF_INTEGER_32 *)(Current + RTWA(5263, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 12L);
							RTHOOK(54);
							RTDBGAA(Current, dtype, 5264, 0x10000000, 1); /* value_min */
							*(EIF_INTEGER_32 *)(Current + RTWA(5264, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
							RTHOOK(55);
									...
									*(EIF_INTEGER_32 *)(Current + RTWA(5265, dtype)) = (EIF_INTEGER_32) ti4_1;
									...
									if (tb1) {
										...
										*(EIF_INTEGER_32 *)(Current + RTWA(5261, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
										...
										RTHOOK(80);
										RTDBGAA(Current, dtype, 5263, 0x10000000, 1); /* value_max */
										*(EIF_INTEGER_32 *)(Current + RTWA(5263, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 24L);
										RTHOOK(81);
										RTDBGAA(Current, dtype, 5264, 0x10000000, 1); /* value_min */
												...
												*(EIF_INTEGER_32 *)(Current + RTWA(5265, dtype)) = (EIF_INTEGER_32) ti4_1;
												...
												if (tb1) {
													...
													*(EIF_INTEGER_32 *)(Current + RTWA(5261, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
													...
													RTHOOK(107);
													RTDBGAA(Current, dtype, 5263, 0x10000000, 1); /* value_max */
													*(EIF_INTEGER_32 *)(Current + RTWA(5263, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 59L);
													RTHOOK(108);
													RTDBGAA(Current, dtype, 5264, 0x10000000, 1); /* value_min */
													*(EIF_INTEGER_32 *)(Current + RTWA(5264, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
													RTHOOK(109);
															...
															if (tb1) {
																...
																*(EIF_INTEGER_32 *)(Current + RTWA(5265, dtype)) = (EIF_INTEGER_32) ti4_1;
																...
																if (tb1) {
																	...
																	*(EIF_INTEGER_32 *)(Current + RTWA(5260, dtype)) = (EIF_INTEGER_32) ti4_1;
																	RTHOOK(141);
																	RTDBGAA(Current, dtype, 5261, 0x10000000, 1); /* count_min */
																	*(EIF_INTEGER_32 *)(Current + RTWA(5261, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1L);
																	RTHOOK(142);
	...
	RTHOOK(206);
	RTDBGAA(Current, dtype, 5262, 0xF80000DE, 0); /* name */
	RTAR(Current, loc1);
	*(EIF_REFERENCE *)(Current + RTWA(5262, dtype)) = (EIF_REFERENCE) RTCCL(loc1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(207);
		RTCT("value_set", EX_POST);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5259, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F986_7478 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F986_7497 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT8;
