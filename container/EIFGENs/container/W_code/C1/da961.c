...
{
	GTCX
	RTOTC (F961_7123,13391,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F961_7128,13396,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F961_7129,13397,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F961_7130,13390,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit961 (void)
{
	GTCX
	RTOTS (7123,F961_7123)
	RTOTS (7124,F961_7124)
	RTOTS (7125,F961_7125)
	RTOTS (7126,F961_7126)
	RTOTS (7127,F961_7127)
	RTOTS (7128,F961_7128)
	RTOTS (7129,F961_7129)
	RTOTS (7130,F961_7130)
}
